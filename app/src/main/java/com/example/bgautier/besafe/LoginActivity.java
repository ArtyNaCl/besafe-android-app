...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_login.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                EditText login2 = (EditText) findViewById (R.id.phone);
                String login = login2.getText().toString();
                EditText MDP2 = (EditText) findViewById (R.id.password);
                String mdp = MDP2.getText().toString();
                callApiLogin("/login",login , mdp);
            }
        });
    ...
    public void callApiLogin(String url, final String login , final String mdp){

        RequestQueue queue = Volley.newRequestQueue(this);
        String trueUrl ="http://hdaroit.fr:3000/api/appusers"+url;
